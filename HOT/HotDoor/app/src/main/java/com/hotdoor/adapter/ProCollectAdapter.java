...
public class ProCollectAdapter extends BaseAdapter {
    ...
    public ProCollectAdapter(Context context, ArrayList<ProListItem> Item) {
    ...
    @Override
    public int getViewTypeCount() {    //重写getViewTypeCount
        // menu type count
        return 2;    //返回type数量
    }

    @Override
    public int getItemViewType(int position) { //重写getItemViewType，
        // current menu type
        return position % 2;  //返回当前position对应的position
    }
